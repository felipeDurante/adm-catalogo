...
public class ListCategoriesUseCaseIT {
    ...
    @BeforeEach
        // para todos os casos que temos nessa classe, irá ter essas categorias
    void mockUp() {
    ...
    public void givenAValidSortAndDirection_whenCallsListCategories_thenShouldReturnCategoriesOrdered(
        ...
        actualResult.items().forEach(categoryListOutput -> System.out.println(categoryListOutput.createdAt()));
