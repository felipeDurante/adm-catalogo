...
public class GenreTest {
    ...
    @Test
    public void givenValidParams_whenCallNewGenre_shouldInstantiteAGenre() {
    ...
    @Test
    public void givenInvalidNullName_whenCallNewGenre_shouldReturnError() {
...
//        final var actualGenre = Genre.newGenre(expectedName, expectedIsActive);
        ...
        Assertions.assertEquals(expectedErrorMessage, exception.getErros().get(0).message());
        Assertions.assertEquals(expectedErrorCount, exception.getErros().size());

    }

    @Test
    public void givenInvalidEmptyName_whenCallNewGenre_shouldReturnError() {
